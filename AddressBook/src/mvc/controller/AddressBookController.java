...
public class AddressBookController {
    ...
    private void openAdd(){   
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
            ...
            String lastname = contactDetailsPanel.getLastnameField().getText();
            ...
            {    
             ...
             person.setData(name,lastname,mobile,email,address);
   ...
   */
    ...
    public Boolean validate(){
        ...
        String email = contactDetailsPanel.geteMailField().getText();
        String address = contactDetailsPanel.getAddressfield().getText();
        if (name==null||name.equals("")||(mobile==null||mobile.equals(""))||(email==null||email.equals(""))||(lastname==null||lastname.equals(""))||(address==null||address.equals("")))
    ...
    private void openEdit(){
        ...
        dialog.getPanel().setLastName(detailPanel.getLastnameField().getText());
    ...
    public void loadPersons()       
    {
        ...
        nlp.getJList().addListSelectionListener(new ListSelectionListener()
         ...
         detailPanel.getLastnameField().setEditable(false);
