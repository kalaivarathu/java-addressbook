    ...
    {   
       try
       {
          conn = DBConnection.getInstance().getConnect();
           ...
           String qry;
           qry = "insert into AddressBook values ('"+person.getName()+"','"+person.getLastname()+"','"+person.getMob()+"','"+person.getEmail()+"','"+person.getAddress()+"')";
    ...
    @Override
     public void updatePerson(Person person,String name)
     {
         try
       {
           ...
           st = conn.createStatement();
            String qry;
            qry="update AddressBook set name='"+person.getName()+"',lastname='"+person.getLastname()+"',mob='"+person.getMob()+"',email='"+person.getEmail()+"',address='"+person.getAddress()+"' where name='"+name+"'";
           st.executeUpdate(qry);
           conn.close();
        }
    ...
    public void getSelectedName(DetailViewPanel detailPanel,String selectedName)
    {
        try {
            ...
            while(rs.next()){
             ...
             detailPanel.setLastName(rs.getString("lastname"));
